...
terraform {
  backend "azurerm" {
    ...
    key = "tfDeployment.terraform.tfstate"     ## Change this to whatever resource you are provisioning eg. key = "baas.terraform.tfstate" or key = "DLTcosmosDB.terraform.tfstate"
